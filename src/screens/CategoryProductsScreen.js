            ...
            <View style={Styles.sectionContainer}>                
                ...
                <View style={Styles.categoryProductSection}>                                  
                    ...
                    <View style={Styles.categoryProductSectionText}>
                        ...
                        <Text style={Styles.categoryProductText}>макі з лососем½ , макі філа ½ , макі з огірком½, макі з авокадо½, філадельфія з лососем½ , філадельфія з вугрем </Text>
                        <TouchableOpacity onPress = {() => {}}>
                            <View styl ={Styles.categoryProductButton}>
                                <Text style = {Styles.categoryProductButtonText}>ЗАМОВИТИ</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
